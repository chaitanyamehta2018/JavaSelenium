...
public class VerifyLoginAndLogoutSuccessfulTest {
    
    public VerifyLoginAndLogoutSuccessfulTest(){
    ...
    public void testMain() throws InterruptedException {
        ...
        try {
           ...
           WebElement element5 = driver.findElement(By.className("wp-block-group"));
           assertTrue(element5.isDisplayed(), "Logout button is displayed");
           element5.click();    
           
           WebElement element6 = driver.findElement(By.xpath("//*[@id='login']/h2"));
           assertTrue(element6.isDisplayed(), "Again Login Page displayed");
